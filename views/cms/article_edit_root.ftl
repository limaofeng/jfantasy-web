...
<script type="text/javascript">
    $(function () {
        var imageUploader = $('#imageUploader').upload({data:{'dir':'cms_image'},theme:'image',size:'160x160'},<@s.property value="@com.fantasy.framework.util.jackson.JSON@serialize(art.coverImage)" escapeHtml="false" default="[]"/>==null?null:[<@s.property value="@com.fantasy.framework.util.jackson.JSON@serialize(art.coverImage)" escapeHtml="false" default="[]"/>]);
        $("#saveForm").ajaxForm({
...
<div class="pad10L pad10R">
    ...
    <@s.form id="saveForm" namespace="/cms/article" action="article_save" method="post" cssClass="center-margin">
        ...
        <@s.hidden name="version.number" value="Article_v1"/>
