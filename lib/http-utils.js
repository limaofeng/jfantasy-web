...
httputil.prototype.get = function () {
    return invoke.apply(this, Array.prototype.concat.apply(['GET'], arguments));
};

httputil.prototype.post = function () {
    return invoke.apply(this, Array.prototype.concat.apply(['POST'], arguments));
};

httputil.prototype.delete = function () {
    return invoke.apply(this, Array.prototype.concat.apply(['DELETE'], arguments));
};

httputil.prototype.put = function () {
    return invoke.apply(this, Array.prototype.concat.apply(['PUT'], arguments));
};
